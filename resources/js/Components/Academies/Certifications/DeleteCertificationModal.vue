<template>
    ...
    <Modal maxWidth="lg" :id="id">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('delete') }} {{ __('certification') }}</h5>
...
export default {
    ...
    methods:{
        remove(){
            this.form.delete(this.route('academies.academy_certifications.destroy',this.modalData.id), {
                preserveState: true,
                preserveScroll: true,
                onSuccess: () => {
