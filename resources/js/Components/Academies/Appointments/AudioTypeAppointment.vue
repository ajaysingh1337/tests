<template>
    ...
    <div v-else>
                            ...
                            <div v-if="Object.keys(form.generated_slots).length > 0"
                                ...
                                <div>
                                    <div
                                        ...
                                        <div>
                                            <span class="fw-bold">{{ __('You have successfully generated slots')
                                                }}</span>
                                        </div>
                                                ...
                                                <div class="accordion-body p-2 time-slots-list"
                                                    ...
                                                    <div v-if="form.generated_slots[day.value]"
                                                        ...
                                                        <ul class="list-unstyled d-flex flex-wrap">
                                                            <li class="mb-2 p-2 m-1 rounded-5 border border-primary"
                                                                v-for="(slot, index) in form.generated_slots[day.value]" :key="index" :class="slot.is_active ? '' : 'bg-light text-muted border-light' " @click="changeSlotStatus(index, day.value)">
                        ...
                        <div class="accordion-body p-2 position-relative time-slots-list">
                            <div v-if="schedules[day.value]" class="position-relative">
                                <ul class="list-unstyled d-flex flex-wrap mb-0">
                                    <li class="mb-2 p-2 m-1 shadow-sm" v-for="(slot, index) in schedules[day.value]
        .schedule_slots" :key="index">
        ...
        __("start time")
                                        ...
                                        <div class="col-4">
                                            <div class="">
                                                <label class="fs-5 fw-bold mb-2" for="end_time">{{ __("end time")
                                                    }}</label>
                                        ...
                                        <div class="col-4">
                                            <div class="">
                                                <label class="fs-5 fw-bold mb-2" for="interval">{{ __("interval")
                                                    }}</label>
                                    ...
                                    <div v-if="addForm.generated_slots.length > 0">
                                        <div class="row border shadow-sm mt-3 rounded-5 mx-3">
                                            ...
                                            <div class="col-md-12 mt-3 time-slots-list"
                                                ...
                                                <ul class="list-unstyled d-flex flex-wrap">
                                                    <li class="mb-2 p-2 m-1 rounded-5 border border-primary" v-for="(
                                          slot, slotIndex
                                        ) in addForm.generated_slots" :key="slotIndex">
                                                        <span>{{ slot.start_time }}
                                                            <i class="bi bi-arrow-left-right text-primary"
                                                                :class="slot.is_active ? '' : 'text-muted'"></i>
                                                            {{ slot.end_time }}</span>
