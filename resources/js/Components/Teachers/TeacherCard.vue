<template>
    <div class="card ms-4 me-5  mx-md-2 w-100 h-100">
      <div class="px-3 pt-3">
      ...
      <div class="card-body px-4">
        ...
        <div class="d-flex align-items-center">
          <span class="fs-4 fw-lightbold" v-if="teacher.experience == 1">{{ teacher.experience }} {{ __("Years Experience") }}</span>
          <span class="fs-4 fw-lightbold" v-else>{{ teacher.experience }} {{ __("Years Experience") }}</span>
