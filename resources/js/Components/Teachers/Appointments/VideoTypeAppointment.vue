                                    ...
                                    <div class="row p-4 bg-primary bg-opacity-10 rounded-5 mx-0">
                                        ...
                                        <div class="col-12">
                                            <p v-if="isCommissionEnabled()"><b>Note:</b>
                                                ...
                                                is <span
                                                    v-if="commission && commission.commission_type == 'fixed_rate'">{{
                                                    getDefaultCurrencySymbol() }} {{ commission.rate }}</span>
                                                    <span v-if="commission && commission.commission_type == 'percentage'"> {{
                                                    commission.rate }}%</span> of the final amount, which is equivalent
                                    ...
                                    <div class="accordion border-0 p-0" id="accordionExample">
                                        <div class="accordion-item border-0  rounded-4 mb-3"
                                            ...
                                            <div class="accordion-header rounded-4 shadow-none d-flex align-items-center justify-content-between w-100 py-2 px-3"
                                                style="background-color: #E7F3FA;" :id="'headingOne' + dayIndex">
...
export default defineComponent({
    ...
    methods: {
        ...
        getAppointmentschedules() {
            ...
            axios
                .get(
                    this.route("teacher.getApiAppointmentSchedules", {
        ...
        getAppointmentCommission() {
            ...
            axios
                .get(
                    this.route("teacher.getApiAppointmentCommission", {
                        appointment_type_id: this.form.appointment_type_id,
                    })
                )
                .then((res) => {
        ...
        submit() {
            this.form.post(this.route("teacher.save_appointment_schedules"), {
                onSuccess: () => {
        ...
        deleteSelectDaySlots(day_value, model_id) {
            ...
            this.deleteForm.post(
                this.route("teacher.delete_appointment_slots"),
                {
                    onSuccess: () => {
        ...
        addSelectDaySlots(day_value, model_id) {
            ...
            this.addForm.post(
                this.route("teacher.add_new_appointment_schedules"),
                {
                    onSuccess: () => {
                        document.getElementById(model_id).click();
                        this.addForm.day = "";
