...
export default defineComponent({
  ...
  methods: {
    ...
    async generateAgoraToken() {
        ...
        if(this.appointment.id){
            this.option.channel=`meeting-${this.appointment.id}`;
        }else{
  ...
  try {
    ...
    console.log("incomingCall", this.option.appid);

    Echo.private(`make-agora-call.${this.appointment.id}`)
      .listen(".make-agora-call", (e) => {
        try {
          console.log(e);
          if (
          ...
          console.error("Error handling Agora call event:", error);
        }
      }).error((err) => {
    ...
    try {
      ...
      rtc.on("stream-subscribed", (evt) => {
        try {
          ...
          console.error("Error handling stream-subscribed event:", error);
        }
      });
      ...
      rtc.on("stream-removed", (evt) => {
        try {
          ...
          console.error("Error handling stream-removed event:", error);
        }
      });
      ...
      rtc.on("peer-online", (evt) => {
        try {
          ...
          console.error("Error handling peer-online event:", error);
        }
      });
      ...
      rtc.on("peer-leave", (evt) => {
        try {
          ...
          console.error("Error handling peer-leave event:", error);
        }
      });
    } catch (error) {
      console.error("Error initializing RTCClient:", error);
    }
    ...
    if (this.$page.props.auth.logged_in_as == "teacher" || this.$page.props.auth.logged_in_as == "academy") {
      ...
      try {
        ...
        console.error("Error auto-joining Agora call:", error);
      }
    }
  } catch (error) {
