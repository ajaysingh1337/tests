                                    ...
                                    <form class="form-horizontal" id="example-form"
                                        ...
                                        <div class="card-js form-group --payment-card">
                                            ...
                                            <input class="name form-control"
                                                   ...
                                                   autocomplete="off"
                                                   required>
                                            <input class="expiry form-control" placeholder="Expiry"
                                                   autocomplete="off"
                                                   required>
                                            <input class="expiry-month" placeholder="Expiry Month" name="expiry_month">
                                            <input class="expiry-year" placeholder="Expiry Year" name="expiry_year">
                                        ...
                                        <button type="submit" class="btn greenColorBg mt-3">@lang('Submit')</button>
                                    </form>
