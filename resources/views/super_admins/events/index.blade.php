        ...
        <div class="row align-items-center mb-4 pt-4 pt-lg-0">
            ...
            <div class="col-md-5">
                {{-- <div class="d-flex justify-content-start justify-content-md-end">
                    ...
                    <i class="fa fa-plus-circle" aria-hidden="true"></i><span class="ml-2">Add Events</span>
                    </a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(!$event->is_approved)
                                            ...
                                            @endif
                                            <a class="btn btn-primary" href="{{ route('super_admin.events.show', ['event' => $event->id]) }}" data-toggle="tooltip" data-placement="bottom" title="View Detail"><i class="fa fa-eye"></i></a>
                                            <a class="ml-2 btn btn-secondary" href="{{ route('super_admin.events.edit', ['event' => $event->id]) }}" data-toggle="tooltip" data-placement="bottom" title="Edit Detail"><i class="fa fa-edit"></i></a>
                                            {{-- edit --}}
                                            <button type="button" class="btn btn-danger ml-2" data-toggle="modal" data-target="#deleteModal{{ $event->id }}" data-toggle="tooltip" data-placement="bottom" title="Delete">
                                        ...
                                        <div class="modal fade" id="deleteModal{{ $event->id }}" style="display: none;" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('super_admin.events.destroy', ['event' => $event->id]) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                        ...
                                        <div class="d-flex">
                                            {{-- restore --}}
                                            <button type="button" class="btn btn-primary ml-2" data-toggle="modal" data-target="#restoreModal{{ $event->id }}">
                                                <i class="fa fa-trash-restore"></i>
                                            </button>
                                            {{-- delete permanently --}}
                                            <button type="button" class="btn btn-danger ml-2" data-toggle="modal" data-target="#deleteModal{{ $event->id }}">
                                                <i class="fa fa-trash"></i>
                                            </button>
                                        </div>
