                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            value="{{ old('starts_at', $event->starts_at ? $event->starts_at->toDateString() : '') }}" name="starts_at"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="date" min="{{ now()->toDateString() }}"
                                            value="{{ old('ends_at', $event->ends_at ? $event->ends_at->toDateString() : '') }}" name="ends_at"
