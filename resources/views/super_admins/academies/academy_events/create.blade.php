            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.academies.edit' , $academy->id) }}">Academy Profile</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.academy_events.index' , $academy->id) }}">Academy Events</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.academy_events.store' , $academy->id) }}"
