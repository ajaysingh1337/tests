        ...
        <div class="row mb-4 pt-4 pt-lg-0">
            ...
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('super_admin.academy_archives.index' , $academy->id) }}">Archives </a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.academy_archives.update', ['academy' => $academy->id , 'academy_archive' => $academy_archive->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                    ...
                                    <div class="tab-content mt-2 p-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade mb-2 {{$key == 0 ? 'show active':''}}" id="nav-{{$language->code}}" role="tabpanel" aria-labelledby="nav-{{$language->code}}-tab">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$language->code}}]" value="{{ $academy_archive->getTranslation('name', $language->code); }}" class="form-control @if ($errors->has('name.'.$language->code)) is-invalid @endif" id="InputName-{{$language->code}}" placeholder="Please Enter" aria-describedby="NameError-{{$language->code}}" aria-invalid="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description[{{$language->code}}]" id="discription_editor_{{$language->code}}" class="form-control @if ($errors->has('description.'.$language->code)) is-invalid @endif" rows="3" placeholder="Please Enter" aria-describedby="DescriptionError-{{$language->code}}" aria-invalid="true">{{ $academy_archive->getTranslation('description', $language->code); }}</textarea>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select aria-describedby="PostCategoryError" aria-invalid="true" id="faq_categories_drop_down" class="form-control curr-sym @if ($errors->has('archive_category_id')) is-invalid @endif" name="archive_category_id">
                                            ...
                                            <option value="{{ $archive_category->id }}" {{ $academy_archive->archive_category_id == $archive_category->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file-preview">
                                            <img src="{{ url($academy_archive->image) }}" width="75px" height="75px" alt="{{ $academy_archive->name }}">
                                        </div>
                                        @else
                                        <div class="custom-file-preview">
                                            -- No Image Selected
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="is_active" value="1" @if ($academy_archive->is_active) checked @endif class="custom-control-input"
