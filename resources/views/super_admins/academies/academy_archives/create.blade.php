            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.academy_archives.index' , $academy->id) }}">Academy Archives</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.academy_archives.store' , $academy->id) }}"
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="BlogCategoryError" aria-invalid="true"
                                                ...
                                                class="form-control curr-sym @if ($errors->has('archive_category_id')) is-invalid @endif"
                                                ...
                                                @if (count($archive_categories) > 0)
                                                    ...
                                                    @foreach ($archive_categories as $archive_category)
                                                        <option value="{{ $archive_category->id }}"
                                                            {{ old('archive_category_id') == $archive_category->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select multiple aria-describedby="TagsError" aria-invalid="true"
                                                ...
                                                name="tag_ids[]">
                                                @if (count($tags) > 0)
                                                    <option value="">Select Archive Tags</option>
                                                    @foreach ($tags as $tag)
                                                        <option value="{{ $tag->id }}"
