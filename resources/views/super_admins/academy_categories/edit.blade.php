    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    <h2 class="main-content-title fw-bold mb-0">Academy Category</h2>
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.academy_categories.index') }}">Academy
                                Categories</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <form id="quickForm" method="POST"
                            action="{{ route('super_admin.academy_categories.update', ['academy_category' => $academy_category->id]) }}"
                        ...
                        <div class="row">
                            <div class="w-100">
                                    ...
                                    <div class="tab-content mt-2 p-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade mb-2 {{$key == 0 ? 'show active':''}}" id="nav-{{$language->code}}" role="tabpanel" aria-labelledby="nav-{{$language->code}}-tab">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$language->code}}]" value="{{ $academy_category->getTranslation('name', $language->code); }}" class="form-control @if ($errors->has('name.'.$language->code)) is-invalid @endif" id="InputName-{{$language->code}}" placeholder="Please Enter" aria-describedby="NameError-{{$language->code}}" aria-invalid="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description[{{$language->code}}]" id="discription_editor_{{$language->code}}" class="form-control @if ($errors->has('description.'.$language->code)) is-invalid @endif" rows="3" placeholder="Please Enter" aria-describedby="DescriptionError-{{$language->code}}" aria-invalid="true">{{ $academy_category->getTranslation('description', $language->code); }}</textarea>
                                ...
                                @if (isset($academy_main_categories))
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        <label for="InputName">Select Parent Category :</label>
                                        <select aria-describedby="ParentCategoryError" aria-invalid="true"
                                            id="academy_main_categories_drop_down"
                                            class="form-control curr-sym @if ($errors->has('parent_category_id')) is-invalid @endif"
                                            name="parent_category_id">
                                            @if (count($academy_main_categories) > 0)
                                                <option value="">Select Parent Category</option>
                                                @foreach ($academy_main_categories as $parent_category)
                                                    <option value="{{ $parent_category->id }}"
                                                        {{ $academy_category->parent_category_id == $parent_category->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    ...
                                    <input type="file" name="imageFile"
                                        ...
                                        <div class="custom-file-preview">
                                            <img src="{{ url($academy_category->image) }}" width="75px" height="75px"
                                                alt="{{ $academy_category->name }}">
                                        </div>
                                        @else
                                        <div class="custom-file-preview">
                                            -- No Image Selected
                                ...
                                <div class="col-md-12 col-lg-4">
                                    ...
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" name="is_active" value="1"
                                            @if ($academy_category->is_active) checked @endif class="custom-control-input"
