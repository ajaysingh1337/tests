            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.teachers.edit' , $teacher->id) }}">Tutor Profile</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.teacher_events.index' , $teacher->id) }}">Tutor Events</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.teacher_events.store' , $teacher->id) }}"
                                 ...
                                 @endif
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <input type="text" name="sponsor" value="{{ old('sponsor') }}"
                                                class="form-control @if ($errors->has('sponsor')) is-invalid @endif"
                                                id="InputSponsor" placeholder="Enter Sponsor" aria-describedby="SponsorError"
                                                aria-invalid="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="datetime-local" min="<?= date('Y-m-d\TH:i'); ?>" name="starts_at" value="{{ old('starts_at') }}"
                                                class="form-control @if ($errors->has('starts_at')) is-invalid @endif"
                                                id="InputSponsor" placeholder="Enter StartAt" aria-describedby="SponsorError"
                                                aria-invalid="true">
                                            <span id="SponsorError" class="error invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required type="datetime-local" min="<?= date('Y-m-d\TH:i'); ?>" name="ends_at" value="{{ old('ends_at') }}"
                                        ...
                                        <div class="form-group">
                                            <label for="InputSponsor">Address Line 1</label>
                                            <input type="text" name="address_line_1" value="{{ old('address_line_1') }}"
                                                ...
                                                id="InputSponsor" placeholder="Enter Address Line 1" aria-describedby="SponsorError"
                                                aria-invalid="true">
                                            <span id="SponsorError" class="error invalid-feedback">
                                        ...
                                        <div class="form-group">
                                            <label for="InputSponsor">Address Line 2</label>
                                            <input type="text" name="address_line_2" value="{{ old('address_line_2') }}"
                                                ...
                                                id="InputSponsor" placeholder="Enter Address Line 2" aria-describedby="SponsorError"
                                                aria-invalid="true">
                                            <span id="SponsorError" class="error invalid-feedback">
