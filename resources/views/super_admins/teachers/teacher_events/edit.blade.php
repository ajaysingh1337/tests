        ...
        <div class="row mb-4 pt-4 pt-lg-0">
            ...
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('super_admin.teachers.index') }}">Tutor</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('super_admin.teacher_events.index' , $teacher->id) }}">Events </a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.teacher_events.update', ['teacher' => $teacher->id , 'teacher_event' => $teacher_event->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                    ...
                                    <div class="tab-content mt-2 p-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade mb-2 {{$key == 0 ? 'show active':''}}" id="nav-{{$language->code}}" role="tabpanel" aria-labelledby="nav-{{$language->code}}-tab">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$language->code}}]" value="{{ $teacher_event->getTranslation('name', $language->code); }}" class="form-control @if ($errors->has('name.'.$language->code)) is-invalid @endif" id="InputName-{{$language->code}}" placeholder="Please Enter" aria-describedby="NameError-{{$language->code}}" aria-invalid="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description[{{$language->code}}]" id="discription_editor_{{$language->code}}" class="form-control @if ($errors->has('description.'.$language->code)) is-invalid @endif" rows="3" placeholder="Please Enter" aria-describedby="DescriptionError-{{$language->code}}" aria-invalid="true">{{ $teacher_event->getTranslation('description', $language->code); }}</textarea>
                            ...
                            @if (isset($event_categories))
                                                    ...
                                                    @if (count($event_categories) > 0)
                                                        ...
                                                        @foreach ($event_categories as $event_category)
                                                            <option value="{{ $event_category->id }}"
                                                                {{ $teacher_event->event_category_id == $event_category->id ? 'selected' : '' }}>
                                                                {{ $event_category->name }}
                                                            </option>
                                                        @endforeach
                                                    @else
                                ...
                                <div class="col-md-12">
                                    ...
                                    <!-- <div class="form-group">
                                        ...
                                        <input type="text" name="sponsor" value="{{ $teacher_event->sponsor }}" class="form-control @if ($errors->has('sponsor')) is-invalid @endif" id="InputName" placeholder="Please Enter" aria-describedby="NameError" aria-invalid="true">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="datetime-local"  min="<?= date('Y-m-d\TH:i'); ?>"  name="starts_at" value="{{ $teacher_event->starts_at }}" class="form-control @if ($errors->has('starts_at')) is-invalid @endif" id="InputName" placeholder="Please Enter" aria-describedby="NameError" aria-invalid="true">
                                        <span id="NameError" class="error invalid-feedback">
                                        ...
                                        <input required type="datetime-local"  min="<?= date('Y-m-d\TH:i'); ?>"  name="ends_at" value="{{ $teacher_event->ends_at }}" class="form-control @if ($errors->has('ends_at')) is-invalid @endif" id="InputName" placeholder="Please Enter" aria-describedby="NameError" aria-invalid="true">
                                        <span id="NameError" class="error invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address_line_1" value="{{ $teacher_event->address_line_1 }}" class="form-control @if ($errors->has('address_line_1')) is-invalid @endif" id="InputName" placeholder="Please Enter" aria-describedby="NameError" aria-invalid="true">
                                        <span id="NameError" class="error invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address_line_2" value="{{ $teacher_event->address_line_2 }}" class="form-control @if ($errors->has('address_line_2')) is-invalid @endif" id="InputName" placeholder="Please Enter" aria-describedby="NameError" aria-invalid="true">
                                        <span id="NameError" class="error invalid-feedback">
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if ($teacher_event->image)
                                        <div class="custom-file-preview">
                                            <img src="{{ url($teacher_event->image) }}" width="75px" height="75px" alt="{{ $teacher_event->name }}">
                                        </div>
                                        @else
                                        <div class="custom-file-preview">
                                            -- No Image Selected
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="is_active" value="1" @if ($teacher_event->is_active) checked @endif class="custom-control-input"
...
<script>
        ...
        $(document).ready(function() {
            ...
            var eventSponsors = {!! json_encode($teacher_event->sponsers) !!};
