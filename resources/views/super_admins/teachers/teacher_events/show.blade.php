            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.teacher_events.index' , $teacher->id) }}">Events
                                </a></li>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $teacher_event->name ? $teacher_event->name : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Strats At</h6>
                                        <p class="mb-0 text-muted">{{ $teacher_event->starts_at ? $teacher_event->starts_at : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Ends At</h6>
                                        <p class="mb-0 text-muted">{{ $teacher_event->ends_at ? $teacher_event->ends_at : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Address Line 1</h6>
                                        <p class="mb-0 text-muted">{{ $teacher_event->address_line_1 ? $teacher_event->address_line_1 : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Address Line 2</h6>
                                        <p class="mb-0 text-muted">{{ $teacher_event->address_line_2 ? $teacher_event->address_line_2 : '--' }}</p>
                                    </div>
                                </div>
                                    ...
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">
                                            @if ($teacher_event->image)
                                                <img class="mt-3" src="{{ url($teacher_event->image) }}" width="75px" height="75px"
                                                    alt="{{ $teacher_event->slug }}">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $teacher_event->slug ? $teacher_event->slug : '--' }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{{ $teacher_event->is_active ? 'Active' : 'Inactive' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Created At</h6>
                                        <p class="mb-0 text-muted">{{ date_format($teacher_event->created_at, 'd-m-Y') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="border h-100  rounded p-3 border-light">
                                        ...
                                        <p class="mb-0 text-muted">{!! $teacher_event->description !!}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
