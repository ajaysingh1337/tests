        ...
        <div class="row mb-4 pt-4 pt-lg-0">
            ...
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('super_admin.teacher_broadcasts.index' , $teacher->id) }}">Broadcasts </a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.teacher_broadcasts.update', ['teacher' => $teacher->id , 'teacher_broadcast' => $teacher_broadcast->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                                    ...
                                    <div class="tab-content mt-2 p-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade mb-2 {{$key == 0 ? 'show active':''}}" id="nav-{{$language->code}}" role="tabpanel" aria-labelledby="nav-{{$language->code}}-tab">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$language->code}}]" value="{{ $teacher_broadcast->getTranslation('name', $language->code); }}" class="form-control @if ($errors->has('name.'.$language->code)) is-invalid @endif" id="InputName-{{$language->code}}" placeholder="Please Enter" aria-describedby="NameError-{{$language->code}}" aria-invalid="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description[{{$language->code}}]" id="discription_editor_{{$language->code}}" class="form-control @if ($errors->has('description.'.$language->code)) is-invalid @endif" rows="3" placeholder="Please Enter" aria-describedby="DescriptionError-{{$language->code}}" aria-invalid="true">{{ $teacher_broadcast->getTranslation('description', $language->code); }}</textarea>
                                 ...
                                 <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select required id="file_type_drop_down" aria-describedby="FileTypeError" aria-invalid="true"
                                                ...
                                                name="file_type">
                                                    ...
                                                    <option @if ($teacher_broadcast->file_type == 'audio') selected @endif value="audio">Audio</option>
                                                    <option @if ($teacher_broadcast->file_type == 'video') selected @endif value="video">Video</option>
                                            </select>
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="LinkTypeError" aria-invalid="true"
                                                ...
                                                name="link_type">
                                                    <option @if ($teacher_broadcast->link_type == 'internal') selected @endif value="internal">Internal</option>
                                                    <option @if ($teacher_broadcast->link_type == 'external') selected @endif value="external">External</option>
                                            </select>
                                    ...
                                    <div id="internal" class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            @if ($teacher_broadcast->link_type == 'internal')
                                                <div class="custom-file-preview">
                                                    @if($teacher_broadcast->file_type == 'audio')
                                                    <audio controls>
                                                        <source src="{{url($teacher_broadcast->audio)}}" type="audio/mpeg">
                                                        Your browser does not support the audio element.
                                                    </audio>
                                                    @else
                                                    <video controls width="640" height="360">
                                                        <source src="{{url($teacher_broadcast->video)}}" type="video/mp4">
                                    ...
                                    <div id="external" class="col-md-12 col-lg-4">
                                      <div class="form-group">
                                            ...
                                            <input value="{{ $teacher_broadcast->file_url }}" type="text" name="file_url"
                                ...
                                <!-- <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-image-preview">
                                            <img src="{{ url($teacher_broadcast->image) }}" width="75px" height="75px" alt="{{ $teacher_broadcast->image }}">
                                        </div>
                                        @else
                                        <div class="custom-file-preview">
                                            -- No image Selected
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="is_active" value="1" @if ($teacher_broadcast->is_active) checked @endif class="custom-control-input"
