            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.teacher_archives.index' , $teacher->id) }}">Tutor Archives</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.teacher_archives.store' , $teacher->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="BlogCategoryError" aria-invalid="true"
                                                ...
                                                @if (count($archive_categories) > 0)
                                                    ...
                                                    @foreach ($archive_categories as $blog_category)
                                                        <option value="{{ $blog_category->id }}"
                                                            {{ old('archive_category_id') == $blog_category->id ? 'selected' : '' }}>
