            ...
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.teacher_experiences.index' , $teacher->id) }}">Tutor Experiences</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.teacher_experiences.store' , $teacher->id) }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input required type="text" name="company" value="{{ old('company') }}"
                                                class="form-control @if ($errors->has('company')) is-invalid @endif"
                                                id="InputName" placeholder="Enter Company Name" aria-describedby="NameError"
                                                aria-invalid="true">
