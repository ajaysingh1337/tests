        ...
        <div class="row mb-4 pt-4 pt-lg-0">
            ...
            <div class="col-sm-6">
                ...
                <ol class="breadcrumb float-sm-left">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('super_admin.teacher_categories.index') }}">Tutor Categories</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-secondary">
                    ...
                    <!-- form start -->
                    <form id="quickForm" method="POST" action="{{ route('super_admin.teacher_categories.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                        <div class="row">
                            <div class="w-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <select aria-describedby="MainCategoryError" aria-invalid="true" id="teacher_main_categories_drop_down" class="form-control curr-sym @if ($errors->has('parent_category_id')) is-invalid @endif" name="parent_category_id">
                                            @if (count($teacher_main_categories) > 0)
                                            <option value="">Select Parent Category</option>
                                            @foreach ($teacher_main_categories as $parent_category)
                                            <option value="{{ $parent_category->id }}" {{ old('parent_category_id') == $parent_category->id ? 'selected' : '' }}>
                                        ...
                                        <span id="MainCategoryError" class="error invalid-feedback">
