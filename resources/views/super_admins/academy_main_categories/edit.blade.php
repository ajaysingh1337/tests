    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-4 pt-4 pt-lg-0">
                ...
                <div class="col-sm-6">
                    <h2 class="main-content-title fw-bold mb-0">Academy Main Category</h2>
                    <ol class="breadcrumb float-sm-left">
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('super_admin.academy_main_categories.index') }}">Academy Main
                                Categories</a></li>
                        <li class="breadcrumb-item active">
                            Edit Academy Main Category
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <form id="quickForm" method="POST"
                            action="{{ route('super_admin.academy_main_categories.update', ['academy_main_category' => $academy_main_category->id]) }}"
                            ...
                            <div class="w-100">
                                    ...
                                    <div class="tab-content mt-2 p-2" id="myTabContent">
                                        ...
                                        <div class="tab-pane fade mb-2 {{$key == 0 ? 'show active':''}}" id="nav-{{$language->code}}" role="tabpanel" aria-labelledby="nav-{{$language->code}}-tab">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name[{{$language->code}}]" value="{{ $academy_main_category->getTranslation('name', $language->code); }}" class="form-control @if ($errors->has('name.'.$language->code)) is-invalid @endif" id="InputName-{{$language->code}}" placeholder="Please Enter" aria-describedby="NameError-{{$language->code}}" aria-invalid="true">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="description[{{$language->code}}]" id="discription_editor_{{$language->code}}" class="form-control @if ($errors->has('description.'.$language->code)) is-invalid @endif" rows="3" placeholder="Please Enter" aria-describedby="DescriptionError-{{$language->code}}" aria-invalid="true">{{ $academy_main_category->getTranslation('description', $language->code); }}</textarea>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file-preview">
                                            <img src="{{ url($academy_main_category->image) }}" width="75px" height="75px"
                                                alt="{{ $academy_main_category->name }}">
                                        </div>
                                        @else
                                        <div class="custom-file-preview">
                                                -- No Image Selected
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if ($academy_main_category->icon)
                                        <div class="custom-file-preview">
                                            <img src="{{ url($academy_main_category->icon) }}" width="75px" height="75px"
                                                alt="{{ $academy_main_category->icon }}">
                                        </div>
                                        @else
                                        <div class="custom-file-preview">
                                                -- No Image Selected
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="is_active" value="1"
                                                @if ($academy_main_category->is_active) checked @endif class="custom-control-input"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="is_featured" value="1"
                                                @if ($academy_main_category->is_featured) checked @endif class="custom-control-input"
