                            ...
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
                                        <h6 class="fw-bold text-uppercase mb-0">Student Name</h6>
                                        <p class="mb-0 text-muted">{{ $bank_transaction->appointment?->student ? $bank_transaction->appointment?->student?->name : '--' }}</p>
                                    </div>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <div class="border h-100  rounded p-3 border-light">
