            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.faqs.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="FAQCategoryError" aria-invalid="true"
                                                id="faq_categories_drop_down"
                                                class="form-control curr-sym @if ($errors->has('faq_category_id')) is-invalid @endif"
                                                name="faq_category_id">
                                                @if (count($faq_categories) > 0)
                                                    <option value="">Select FAQ Category</option>
                                                    @foreach ($faq_categories as $faq_category)
                                                        <option value="{{ $faq_category->id }}"
                                                            {{ old('faq_category_id') == $faq_category->id ? 'selected' : '' }}>
