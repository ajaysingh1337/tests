            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-secondary">
                        ...
                        <!-- form start -->
                        <form id="quickForm" method="POST" action="{{ route('super_admin.broadcasts.store') }}"
                                ...
                                @if (isset($broadcast_categories))
                                    <div class="col-md-12 col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <select aria-describedby="PodcastCategoryError" aria-invalid="true"
                                                id="faq_categories_drop_down"
                                                class="form-control curr-sym @if ($errors->has('broadcast_category_id')) is-invalid @endif"
                                                name="broadcast_category_id">
                                                @if (count($broadcast_categories) > 0)
                                                    <option value="">Select Media Category</option>
                                                    @foreach ($broadcast_categories as $podcast_category)
                                                        <option value="{{ $podcast_category->id }}"
                                                            {{ old('broadcast_category_id') == $podcast_category->id ? 'selected' : '' }}>
                                                            {{ $podcast_category->name }}</option>
                                                    @endforeach
                                                @else
