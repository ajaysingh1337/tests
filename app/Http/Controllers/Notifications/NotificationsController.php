...
class NotificationsController extends Controller
{
    ...
    public function saveFcmToken(Request $request)
    {
        try {
            ...
            $userType = null;
            if ($request->session()->get('logged_in_as') == 'teacher' && auth()->user()->teacher) {
                $userType = 'teacher';
            } else if ($request->session()->get('logged_in_as') == 'academy' && auth()->user()->academy) {
                $userType = 'academy';
            } else if ($request->session()->get('logged_in_as') == 'student' && auth()->user()->student) {
                $userType = 'student';
            } else {
                $userType = null;
            }
            ...
            $device = Devices::where('user_id', auth()->user()->id)
