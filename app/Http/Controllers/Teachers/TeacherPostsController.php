...
use App\Models\Post;
use App\Http\Requests\Teachers\TeacherPosts\CreateRequest;
...
class TeacherPostsController extends Controller
{
    ...
    public function getter($req = null, $export = null)
    {
        ...
        if ($req != null) {
            ...
            $totalTeacherPosts = $teacher_posts->count();
    ...
    public function show($teacher_post)
    {
        $teacher = auth()->user()->teacher;
        ...
        $teacher_post = $teacher->teacher_posts()->withAll()->find($teacher_post);
        if ($teacher_post) {
            $teacher_post = new PostsResource($teacher_post);
    ...
    public function update(CreateRequest $request, Post $teacher_post)
    {
        ...
        try {
            ...
            $teacher_post = $teacher_post->find($teacher_post->id);
