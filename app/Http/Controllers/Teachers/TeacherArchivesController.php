...
use App\Http\Requests\Teachers\TeacherArchives\CreateRequest;
...
class TeacherArchivesController extends Controller
{
  ...
  public function getter($req = null,$export = null)
  {
    ...
    if($req != null){
      ...
      $totalTeacherArchives = $teacher_archives->count();
  ...
  /********* FILTER TeacherArchives FOR Search ***********/
   public function filter(Request $request){
    ...
    public function show( $teacher_archive)
    {
        $teacher = auth()->user()->teacher;
        ...
        $teacher_archive = $teacher->teacher_archives()->withAll()->find($teacher_archive);
        if($teacher_archive){
          $teacher_archive = new ArchivesResource($teacher_archive);
