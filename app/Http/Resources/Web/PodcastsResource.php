...
class PodcastsResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        $podcast_category = $this->relationLoaded('podcast_category') ? $this->whenLoaded('podcast_category') : null;
        return [
                "id" =>  $this->id,
                ...
                'podcast_category_name' => $podcast_category ? $podcast_category->name :"",
