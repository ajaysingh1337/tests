...
class Podcast extends Model
{
    ...
    protected $fillable = ['teacher_id','academy_id','podcast_category_id', 'is_featured', 'name', 'description', 'slug', 'sort_order', 'image','file_type','link_type','file_url','audio','video', 'is_active', 'deleted_at'];


    public function scopeWithAll($query)
    {
        return $query->with('teacher')->with('academy')->with('tags')->with('podcast_category');
    }
