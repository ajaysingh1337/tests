...
class CallChat extends React.Component {
    ...
    attachSocketListeners() {
        console.log('callchat attachSocketListeners', this.props.rtc_client.socket);
        this.props.rtc_client.socket.on("breakout-room-message", (params) => {
            this.onBreakoutRoomMessage(params);
        });

        this.context.socket.on(`new_message_${this.props.record_type}_${this.props.record_id}`, (message) => {
