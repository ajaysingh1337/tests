...
import BootstrapModal from "reactComponents/Helpers/BootstrapModal";
...
const CallHandler = forwardRef((props, ref) => {
  ...
  const [hostIds, setHostIds] = useState(props.host_ids);
  ...
  useEffect(() => {
    ...
    console.log('props.host_ids',props.host_ids,hostIds);
  }, [props.host_ids]);
...
console.log('Callhandler',isReadyToJoin,props,userStatus,hostIds);
  return (
